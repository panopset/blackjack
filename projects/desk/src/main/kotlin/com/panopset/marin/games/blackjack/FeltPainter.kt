...
import com.panopset.blackjack.engine.BlackjackGameState
...
class FeltPainter {
    ...
    fun draw(cs: com.panopset.blackjack.engine.BlackjackGameState, g: GraphicsContext, width: Int, height: Int) {
    ...
    private fun paintMsgLandscape(cs: com.panopset.blackjack.engine.BlackjackGameState, g: GraphicsContext, t: Tile) {
        initGforMsg(cs, g, t)
        val y = t.bottom - verticalSeparator / 2
        paintMistakeMessage(cs, g, t, y, verticalSeparator)
    }

    private fun initGforMsg(cs: com.panopset.blackjack.engine.BlackjackGameState, g: GraphicsContext, t: Tile) {
        g.fill = Color.BLACK
        g.font = font0
        if (Stringop.isPopulated(cs.mistakeMessage)) {
            g.fill = Color.YELLOW
    ...
    private fun paintMistakeMessage(cs: com.panopset.blackjack.engine.BlackjackGameState, g: GraphicsContext, t: Tile, y: Int, vs: Int) {
        if (Stringop.isPopulated(cs.mistakeMessage)) {
            g.fill = Color.YELLOW
    ...
    private fun paintDealer(g: GraphicsContext, t: Tile, cs: com.panopset.blackjack.engine.BlackjackGameState) {
        if (dbg) {
            g.fill = Color.RED
    ...
    private fun paintPlayer(g: GraphicsContext, t: Tile, cs: com.panopset.blackjack.engine.BlackjackGameState) {
        g.fill = Color.BLACK
        val o = LayoutPlayer(
    ...
    private fun paintStatus(cs: com.panopset.blackjack.engine.BlackjackGameState, g: GraphicsContext, t: Tile) {
        if (dbg) {
            g.fill = Color.BLUE
    ...
    var dbg = false
    private fun paintChips(g: GraphicsContext, t: Tile?, cs: com.panopset.blackjack.engine.BlackjackGameState) {
        if (t == null) {
            return
        }
        if (dbg) {
